...
def SpeakText(command, langinp=LANGUAGE):
    ...
    tts.save("C:/Users/Sarumathi/tempfile01.mp3")
    playsound("C:/Users/Sarumathi/tempfile01.mp3")
    
    os.remove("C:/Users/Sarumathi/tempfile01.mp3")
...
def composeMail():
    ...
    index=0 
    for email in emails:
        emails[index] = email.replace(email, email+"@gmail.com")
        index += 1
...
def searchMail():
    ...
    if cmb == "1" or cmb.lower() == "one":
        ...
        mailBoxTarget = '"[Gmail]/Sent Mail"'
        SpeakText("Sent Mailbox selected.")
    elif cmb == "3" or cmb.lower() == "three" or cmb.lower() == "free" or cmb.lower() == "tree":
        mailBoxTarget = '"[Gmail]/Drafts"'
        SpeakText("Drafts selected.")
    elif cmb == "4" or cmb.lower() == "four":
        mailBoxTarget = '"[Gmail]/Important"'
    ...
    if mailSearchChoice == "1" or mailSearchChoice.lower() == "one":
        ...
        searchSub = searchSub.replace("at", "@")
...
def main():
    ...
    SpeakText("Do You want to continue? Yes or No")
    choice = speech_to_text()
    if choice.lower() == "yes":
        main()
    else:
